...
fixture_properties = {
        ...
        'marathon.application.mainclass' => "webserver.gui.WebServerGUI",
        'marathon.application.arguments' => "",
        'marathon.application.vm.arguments' => "",
        'marathon.application.java.home' => "",
        'marathon.application.working.dir' => "D:\\work\\java-workspace\\eclipse-workspace\\webserver\\bin",
        'marathon.application.classpath' => "%marathon.project.dir%/../../java-workspace/eclipse-workspace/webserver/bin",
